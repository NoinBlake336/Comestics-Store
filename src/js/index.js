...
const renderBlobMaker = () => {
    ...
    //         index++;
    //         if(index==9){
    //             blobMaker.classList.add('animate');
    //         }
