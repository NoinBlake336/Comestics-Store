export const renderProducts = (data) => {
    ...
    return `
    <div  class="card-shadow rounded-2xl p-2 bg-cover bg-center h-[200px] relative overflow-hidden cursor-pointer hover:border-solid hover:border-2 hover:border-[#BA5852] sm:h-96 " style="background-image: url(&quot;${api_featured_image});">
