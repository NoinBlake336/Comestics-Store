...
export const drawingProductsInformations = (date) => {
  ...
  <div class="mt-4 px-3 pb-5">
    ...
    <div class="flex gap-2">
      <button id="add-product-cart" dataset="${id}" href="#" class="flex items-center justify-center rounded-md bg-slate-900 px-3 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
